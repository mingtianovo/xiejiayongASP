...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fa fa-concierge-bell"></i> 客房前台服务</h1>
            <p class="subtitle">欢迎使用格林酒店管理系统前台服务功能</p>
        </div>
        
        <div class="function-grid">
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-bed"></i></div>
                <div class="function-title">房间状态管理</div>
                <div class="function-desc">查看和管理所有房间的入住状态</div>
                <a href="RoomStatus.aspx" class="btn">进入管理</a>
            </div>
            
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-clipboard-list"></i></div>
                <div class="function-title">订单管理</div>
                <div class="function-desc">处理客户预订和订单信息</div>
                <a href="OrderList.aspx" class="btn">查看订单</a>
            </div>
            
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-user-plus"></i></div>
                <div class="function-title">客户登记</div>
                <div class="function-desc">为客户办理入住登记手续</div>
                <a href="CustomerRegister.aspx" class="btn">办理登记</a>
            </div>
            
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-cash-register"></i></div>
                <div class="function-title">账单管理</div>
                <div class="function-desc">处理客户账单和收费</div>
                <a href="Bill.aspx" class="btn">账单管理</a>
            </div>
            
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-search"></i></div>
                <div class="function-title">房间查询</div>
                <div class="function-desc">查询可用房间和房间信息</div>
                <a href="RoomList.aspx" class="btn">查询房间</a>
            </div>
            
            <div class="function-card">
                <div class="function-icon"><i class="fa fa-edit"></i></div>
                <div class="function-title">订单编辑</div>
                <div class="function-desc">修改和更新订单信息</div>
                <a href="OrderEdit.aspx?id=1" class="btn">编辑订单</a>
            </div>
        </div>
